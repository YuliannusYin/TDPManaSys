    ...
    <el-card shadow="never" style="margin-top:16px">
      ...
      <div v-if="responsive.isMobile.value" class="mobile-card-list" v-loading="loading">
        ...
        >
          ...
          <div class="card-body">
            <div class="card-row">
              <span class="card-label">登记号：</span>
              <span class="card-value">{{ row.registrationNo || '-' }}</span>
            </div>
            <div class="card-row">
              <span class="card-label">版本号：</span>
              <span class="card-value">{{ row.version || '-' }}</span>
            </div>
            <div class="card-row">
              <span class="card-label">开发完成日期：</span>
              <span class="card-value">{{ row.devCompletionDate || '-' }}</span>
            </div>
            <div class="card-row">
              <span class="card-label">登记日期：</span>
              <span class="card-value">{{ row.registrationDate || '-' }}</span>
            </div>
            <div class="card-row">
              <span class="card-label">著作权人：</span>
              <span class="card-value card-value-ellipsis" :title="row.copyrightOwners">{{ row.copyrightOwners || '-' }}</span>
            </div>
            <div class="card-row">
